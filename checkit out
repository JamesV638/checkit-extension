# checkit-extension
  AI-powered Chrome extension that fact-checks claims in real-time using Claude's API, cross-referencing non-partisan sources to deliver instant verdicts.
